...
public class GuardVillagers implements ModInitializer {
    ...
    public static final Item GUARD_SPAWN_EGG = Registry.register(
            Registries.ITEM,
            GUARD_SPAWN_EGG_KEY,
            new SpawnEggItem(new Item.Settings().registryKey(GUARD_SPAWN_EGG_KEY)
                    .component(DataComponentTypes.ENTITY_DATA, TypedEntityData.create(GUARD_VILLAGER, new NbtCompound()))));
        ...
        ServerEntityEvents.ENTITY_LOAD.register((entity, world) -> {
            if (entity instanceof VillagerEntity villagerEntity && villagerEntity.isNatural()) {
                ...
                if (world.random.nextFloat() < spawnChance) {
                    ...
                    guardEntity.initialize(world, ((ServerWorld) world).getLocalDifficulty(villagerEntity.getBlockPos()), SpawnReason.NATURAL, null);
